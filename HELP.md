...
Задачи frontend:
1. Исправить длину кнопок слева в /dashboard
2. Какой тег использовать в th:switch (найти через ctrl shift f)
3. Сделать header для всех html из customer
4. Сделать /confirmOrder (по сути нужны просто 2 кнопки) (наверное показывать то же самое, что и в таблице, но в столбик)
5. Сделать /newSupply с выбором произвольного количества товаров и их количества
6. Сделать фильтрацию по тегам в home (+сделать кнопку "применить")
