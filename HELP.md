...
5. Исправить смену цвета у изображения ссылки
6. Сделать фильтрацию по тегам в home (и сделать кнопку "применить")
7. Проверить в каждом файле используются ли нужные классы

Задачи backend:
1. Исправить отображение статуса оплаты в customer/orders
2. Сделать валидацию для номера телефона + везде сделать по 2 символа для имён
3. Разбить все dashboard на отдельные html файлы
4. Исправить проблему с добавлением новых категорий при изменении товара
5. Позволить гостям находиться на /home и /product
6. Сделать личный кабинет (со сменой данных об аккаунте)
7. Исправить названия методов в сервисах (где просто get() на getById() и т.д.)
8. Сделать постраничную работу с бд (то есть работаем условно только с 20 записями за раз)